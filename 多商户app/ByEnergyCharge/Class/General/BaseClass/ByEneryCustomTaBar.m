...
#define LBMagin 10
@interface ByEneryCustomTaBar ()

@property (nonatomic, weak) UIButton *plusBtn ;

@end
@implementation ByEneryCustomTaBar
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"scanItem"] forState:UIControlStateNormal];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"scanItem"] forState:UIControlStateHighlighted];
...
- (void)layoutSubviews {
    ...
    if (IsIphoneXLater) {
        self.plusBtn.centerY = self.height * 0.5 - 2 * 18.5 ;
    }else {

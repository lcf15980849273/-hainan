//
//  BEnergyInvoiceSumChoiceModel.h
//  ByEnergyCharge
//
...
@interface BEnergyInvoiceSumChoiceModel : BEnergyBaseModel
@property (nonatomic, copy) NSString *buyerAddress;
@property (nonatomic, copy) NSString *orderIdList;
@property (nonatomic, copy) NSString *orderId;
@property (nonatomic, copy) NSString *timeMonth;
...
@property (nonatomic, copy) NSString *notReadySum;
@property (nonatomic, copy) NSString *readySum;
...
@property (nonatomic, assign) float orderPayAmount;

...
- (UIButton *)selectPhotoButton {
    if (_selectImageView == nil) {
        ...
        selectPhotoButton.frame = CGRectMake(self.tz_width - 30, 10, 20, 20);
...
- (UIImageView *)selectImageView {
    if (_selectImageView == nil) {
        ...
        selectImageView.frame = CGRectMake(self.tz_width - 30, 10, 20, 20);
...
- (void)setModel:(TZAlbumModel *)model {
    ...
    NSMutableAttributedString *nameString = [[NSMutableAttributedString alloc] initWithString:model.name attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:16],NSForegroundColorAttributeName:[UIColor colorByEnergyWithBinaryString:@"181818"]}];
...
- (UILabel *)titleLable {
    if (_titleLable == nil) {
        ...
        titleLable.textColor = [UIColor colorByEnergyWithBinaryString:@"181818"];

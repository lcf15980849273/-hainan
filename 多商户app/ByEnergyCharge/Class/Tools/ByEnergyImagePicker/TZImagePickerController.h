...
/*
 新添加方法,和上面一个方法功能一样,增加一个type用来决定拉起的相册中(用户可选只展示图片或视频)
...
@property (nonatomic, copy) void (^FinishPickingVideoHandle)(UIImage * coverImage,id asset,AVPlayerItem *playerItem);

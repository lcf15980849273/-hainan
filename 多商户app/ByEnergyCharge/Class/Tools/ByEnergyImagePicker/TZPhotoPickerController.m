...
//    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:tzImagePickerVc.cancelBtnTitleStr style:UIBarButtonItemStylePlain target:tzImagePickerVc action:@selector(cancelButtonClick)];
    UIImage *leftImage = [UIImage imageNamed:@"back_blue"];
    leftImage = [leftImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithImage:leftImage style:UIBarButtonItemStylePlain target:self action:@selector(popVC)];
...
- (void)configCollectionView {
    ...
    layout.itemSize = CGSizeMake(itemWH, itemWH + itemWH * 0.17);
...
- (void)configBottomToolBar {
    ...
    NSString*str=[NSString stringWithFormat:@"已经选择:%zd张",tzImagePickerVc.selectedModels.count];
    tzImagePickerVc.previewBtnTitleStr=str;
    ...
    [_previewButton setTitleColor:[UIColor colorWithRed:26/255.0 green:173/255.0 blue:25/255.0 alpha:1.0]forState:UIControlStateNormal];
    [_previewButton setTitleColor:[UIColor colorWithRed:26/255.0 green:173/255.0 blue:25/255.0 alpha:1.0] forState:UIControlStateDisabled];
    ...
    if (tzImagePickerVc.allowPickingOriginalPhoto) {
        ...
        [_originalPhotoButton setTitleColor:BYENERGYCOLOR(0x181818) forState:UIControlStateSelected];
       // [_originalPhotoButton setImage:[UIImage imageNamedFromMyBundle:tzImagePickerVc.photoOriginDefImageName] forState:UIControlStateNormal];
        ...
        _originalPhotoLable.textColor = BYENERGYCOLOR(0x181818);
   ...
   // _doneButton.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    _doneButton.frame = CGRectMake(self.view.tz_width - 59-44, 10, 50, 30);
    _doneButton.titleLabel.font = [UIFont boldSystemFontOfSize:14];
    [_doneButton addTarget:self action:@selector(doneButtonClick) forControlEvents:UIControlEventTouchUpInside];
    _doneButton.backgroundColor=[UIColor colorWithRed:26/255.0 green:173/255.0 blue:25/255.0 alpha:1.0];
    ...
    _numberImageView.frame = CGRectMake(self.view.tz_width - 59, 10, 44, 30);
    _numberImageView.hidden = tzImagePickerVc.selectedModels.count <= 0;
    _numberImageView.backgroundColor = [UIColor clearColor];
    
    _numberLable = [[UILabel alloc] init];
    _numberLable.frame = _numberImageView.frame;
    _numberLable.font = [UIFont boldSystemFontOfSize:14];
    _numberLable.textColor = [UIColor whiteColor];
    _numberLable.layer.cornerRadius=5;
    _numberLable.clipsToBounds=YES;
    _numberLable.backgroundColor=[UIColor colorWithRed:26/255.0 green:173/255.0 blue:25/255.0 alpha:1.0];
...
- (void)refreshBottomToolBarStatus {
    ...
    _previewButton.enabled = tzImagePickerVc.selectedModels.count > 0;
     [_previewButton setTitle:[NSString stringWithFormat:@"已经选择:%zd张",tzImagePickerVc.selectedModels.count]forState:UIControlStateNormal];
...
//        [ZmSystemJurisdictionHandleTool gotoZmSystemSetter];
//    }
}

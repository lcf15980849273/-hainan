...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorByEnergyWithBinaryString:@"181818"];
...
- (void)callDelegateMethod {
    ...
    if (imagePickerVc.FinishPickingVideoHandle) {
        imagePickerVc.FinishPickingVideoHandle(_cover,_model.asset,_playerItem);
    }
}

...
typedef enum: NSUInteger {
    RYCoverViewTypeForTop,//下落
    RYCoverViewTypeForCenter,//中间弹出
    RYCoverViewTypeForBottom,//底部弹出
}RYCoverViewType;//弹窗显示方式

typedef void(^showBlock)();
typedef void(^hideBlock)();

@interface RYCoverView : UIView

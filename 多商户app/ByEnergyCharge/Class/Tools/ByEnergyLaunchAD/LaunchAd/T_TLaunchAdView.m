...
@interface T_TLaunchAdImageView ()

@end

@implementation T_TLaunchAdImageView
...
@interface T_TLaunchAdVideoView ()<UIGestureRecognizerDelegate>
@property (nonatomic, strong) AVPlayerItem *playerItem;
@end

@implementation T_TLaunchAdVideoView
...
-(void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context {
    if([keyPath isEqualToString:VideoPlayStatus]){
        ...
        if (newStatus == AVPlayerItemStatusFailed) {
            [[NSNotificationCenter defaultCenter] postNotificationName:T_TLaunchAdVideoPlayFailedNotification object:nil userInfo:@{@"videoNameOrURLString":_contentURL.absoluteString}];
        }
    }
}

...
@interface T_TLaunchImageView ()

@end

@implementation T_TLaunchImageView
#pragma mark - private
...
-(UIImage *)imageFromLaunchImage{
    ...
    T_TLaunchAdLog(@"获取LaunchImage失败!请检查是否添加启动图,或者规格是否有误.");
    return nil;
}
...
-(UIImage *)imageFromLaunchScreen{
    ...
    if(UILaunchStoryboardName == nil){
        T_TLaunchAdLog(@"从 LaunchScreen 中获取启动图失败!");
        return nil;
    }

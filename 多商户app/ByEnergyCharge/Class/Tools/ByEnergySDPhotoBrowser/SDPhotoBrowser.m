...
- (void)setupToolbars
{
    ...
    indexLabel.backgroundColor = [[UIColor colorByEnergyWithBinaryString:@"181818"] colorWithAlphaComponent:0.5];
...
- (void)layoutSubviews
{
    ...
    _indexLabel.center = CGPointMake(self.bounds.size.width * 0.5, T_T_IPHONEX ? 45 : 35);
...
- (void)showFirstImage
{
   ...
   // if (self.ignoreFirst) {
        index += self.ignoreNum;
   // }
    UIView *sourceView = self.sourceImagesContainerView.subviews[index];
